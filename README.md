...
Here is the content formatted as a **README.md** file. You can create a file named `README.md` in your GitHub repository or project folder and paste this directly.

I have organized it with a clean table of contents and clear code blocks for your MCA students to navigate easily.

-----

````markdown
# Object Oriented Programming (C++) - Lab Solutions
**Department:** Master of Computer Applications (MCA)  
**Institute:** G.H. Raisoni College of Engineering & Management, Jalgaon  
**Subject:** Object Oriented Programming using C++  
**Instructor:** Prof. Radheshayam Kumar  
...
| :--- | :--- |
| **4** | **Control Statements (If-Else Ladder)** |
| 4.1 | [Find Greater Number](#41-find-greater-number) |
| 4.2 | [Student Grade Calculation](#42-student-grade-calculation) |
| **5** | [Function Overloading](#5-function-overloading) |
| **6** | [Constructor and Destructor](#6-constructor-and-destructor) |
| **7** | [Friend Function](#7-friend-function) |
| **8** | [Friend Class](#8-friend-class) |
| **9** | **Inheritance** |
| 9.1 | [Single Inheritance](#91-single-inheritance) |
| 9.2 | [Multi-level Inheritance](#92-multi-level-inheritance) |
| 9.3 | [Multiple Inheritance](#93-multiple-inheritance) |
| 9.4 | [Hierarchical Inheritance](#94-hierarchical-inheritance) |
| **10** | **Operator Overloading** |
| 10.1 | [Overloading using Member Function](#101-operator-overloading-member-function) |
| 10.2 | [Overloading using Friend Function](#102-operator-overloading-friend-function) |
| **11** | [Virtual Functions](#11-virtual-functions) |
| **12-13** | [Exception Handling (Divide by Zero)](#12--13-exception-handling) |
